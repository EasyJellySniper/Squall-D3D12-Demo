...
enum GpuTimeType
{
	BeginFrame = 0, PrepassWork, UpdateTopLevelAS, TileLightCulling, CollectShadowMap, RayTracingShadow, RayTracingReflection, SkyboxPass, TransparentPass, EndFrame, Count
};
