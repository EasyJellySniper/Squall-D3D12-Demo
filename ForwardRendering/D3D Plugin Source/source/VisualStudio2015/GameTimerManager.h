...
enum GpuTimeType
{
	BeginFrame = 0, PrepassWork, UpdateTopLevelAS, TileLightCulling, CollectShadowMap, RayTracingShadow, RayTracingReflection, RayTracingAmbient, SkyboxPass, TransparentPass, EndFrame, Count
};
